        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-start gap-3">
            <button
              ...
              className="rounded-lg bg-red-500 px-4 py-3 text-sm font-medium text-white transition hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <div className="border-t border-white/10 pt-6">
              ...
              <div className="grid gap-4 md:grid-cols-3 mb-6">
                <div className="rounded-lg border border-white/10 bg-neutral-900/70 p-4 text-center">
                  ...
                  <div className="text-sm text-gray-400">Сколько раз были замечены дефекты</div>
                </div>
                <div className="rounded-lg border border-white/10 bg-neutral-900/70 p-4 text-center">
